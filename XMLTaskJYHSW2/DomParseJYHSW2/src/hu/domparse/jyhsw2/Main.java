				...
				case 1:
					while (exitSubMenu != 1) {
						System.out.println("Meno pontok \r 1. Meresi Adatok \r 2. Mero Eszkoz \r 3. Szerelo "
								+ "\r 4. Telephely \r 5. Gyarto \r 6. Karbantartas \r 7. Kilepes \rValaszon: ");
				...
				case 3:
					...
					System.out.println("Menu pontok \r 1. Meresi Adatok Modositasa"
							+ "\r 2. Mero Eszkoz Adatok Modositasa"
								...
								+ "\r 4.Telephely Adatok Modositasa \r 5. Szerelo Adatok Modositasa "
								+ "\r 6. Kilepes \rValaszon: ");
					int valasztas_2 = sc.nextInt();
					switch (valasztas_2) {
					case 1:
